...
| `/api/attr/getBlockAttrs` | api-wrapper+core | `src/api/block.ts:303`<br>`src/core/write-safety-coordinator.ts:592`<br>`src/core/write-safety-coordinator.ts:938` | 有效内核路由 |
...
| `/api/block/checkBlockExist` | api-wrapper+core | `src/api/block.ts:194`<br>`src/core/write-safety-coordinator.ts:926` | 有效内核路由 |
...
| `/api/block/prependDailyNoteBlock` | api-wrapper | `src/api/block.ts:260` | 有效内核路由 |
